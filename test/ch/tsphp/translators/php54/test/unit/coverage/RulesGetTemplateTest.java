...
/*
 * This file is based on the file RulesGetTemplateTest from the translator component of the TinsPHP project.
...
public class RulesGetTemplateTest
{
    ...
    private static final String WALKER_NAME = PHP54TranslatorWalker.class.getName() + "$";
