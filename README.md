...
It is used to translate a TSPHP-AST, generated by the [parser](https://github.com/tsphp/tsphp-parser) and augmented with type information by the [type checker](https://github.com/tsphp/tsphp-typechecker), to PHP 5.4. 
